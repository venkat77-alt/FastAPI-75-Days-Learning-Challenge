...
app = FastAPI(title="Middleware, Global Exception handler", description="it is day 4 learning modules form my 75 days fastapi learniing challenge. tooday's topic is pydentic v2.")
